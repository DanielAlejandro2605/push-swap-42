...
_SRCS_PS				=	main.c arguments.c arguments_utils.c errors.c push_swap.c mini_push_swap.c \
							mini_ps_utils.c sort.c sort_utils.c \
							list_op_and_inst.c list_instruction.c list_instruction_improve.c \
...
_SRCS_UTILS				=	ft_calloc.c ft_bzero.c ft_strlen_int.c ft_strncmp.c \
...
$(NAME) : $(SRCO_PS) $(SRCO_STACK) $(SRCO_UTILS)
	cc -o $(NAME) $(SRCO_PS) $(SRCO_STACK) $(SRCO_UTILS)
